    ...
    checkItemGame = function (rect,items) {
        for (var i = 0; i < items.length; i++) {
            if (items[i].visible == true) {
                var rectEnemy = cc.rect(items[i].getPositionX()+10 - items[i].getContentSize().width / 2 * items[i].getScaleX(),
                    items[i].getPositionY()+10 - items[i].getContentSize().height / 2 * items[i].getScaleY(),
                    (items[i].getContentSize().width - 20) * items[i].getScaleX(),
                    (items[i].getContentSize().height - 20) * items[i].getScaleY());
